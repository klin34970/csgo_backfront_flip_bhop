/*  <DR.API BACKFLIP> (c) by <De Battista Clint - (https://sourcemod.market) */
/*                                                                           */
...
public void OnPluginStart()
{
	...
	cvar_backflip_rotation						= AutoExecConfig_CreateConVar("drapi_backflip_rotation", 					"8.0", 					"Roation angle", 						DEFAULT_FLAGS);
